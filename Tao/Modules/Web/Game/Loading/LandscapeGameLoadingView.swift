//
//  LandscapeGameLoadingView.swift
...
/// 横屏游戏加载视图
class LandscapeGameLoadingView: UIView, GameLoadingProtocol {
    ...
    private var tips: [String] = [] {
        didSet {
            ...
            tipsLabel.text = "游戏小贴士：" + tips.first!
        }
    }
    ...
    private let progressWidth: CGFloat = 463.adap
    ...
    private func makeConstraints() {
        ...
        progressLabel.snp.makeConstraints { (make) in
            make.left.equalTo(completeProgressImageView.snp.right).offset(8.adap)
            make.centerY.equalTo(completeProgressImageView)
        }
